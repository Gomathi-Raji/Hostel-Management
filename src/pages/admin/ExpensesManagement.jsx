  ...
  const [expenses, setExpenses] = useState([
    {
      ...
      amount: 25000,
      description: "Monthly electricity bill for hostel premises",
      supplier: "State Electricity Board",
      paymentMethod: "Bank Transfer",
      date: "2024-01-15",
      dueDate: "2024-01-20",
      status: "Paid",
      documents: ["electricity_bill_jan_2024.pdf"],
    ...
    },
    {
      ...
      amount: 8500,
      description: "Repair of water pipes in Block A and B",
      supplier: "City Plumbing Services",
      paymentMethod: "Cash",
      date: "2024-01-12",
      dueDate: "2024-01-15",
      status: "Overdue",
      documents: ["plumbing_invoice.pdf", "work_completion.jpg"],
    ...
    },
    {
      ...
      amount: 3200,
      description: "Monthly cleaning supplies and chemicals",
      supplier: "CleanMax Solutions",
      paymentMethod: "UPI",
      date: "2024-01-10",
      dueDate: "2024-01-25",
      status: "Pending",
      documents: ["cleaning_supplies_receipt.pdf"],
    ...
    },
    {
      ...
      supplier: "Guardian Security Agency",
      paymentMethod: "Cheque",
      date: "2024-01-01",
      dueDate: "2024-01-10",
      status: "Paid",
      documents: ["security_contract.pdf", "guard_attendance.xlsx"],
    ...
    },
    {
      ...
      supplier: "Cool Air Technologies",
      paymentMethod: "Bank Transfer",
      date: "2024-01-14",
      dueDate: "2024-01-30",
      status: "Pending",
      documents: ["hvac_service_report.pdf"],
      createdAt: "2024-01-10",
      paidDate: null
    }
  ]);
