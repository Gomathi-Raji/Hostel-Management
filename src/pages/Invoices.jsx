...
const Invoices = () => {
  ...
  // Only allow download of paid invoices
  ...
  // Count paid invoices for download all button
  const paidInvoicesCount = invoices.filter(invoice => isInvoicePaid(invoice)).length;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        ...
        <button
          ...
          className={`mt-4 sm:mt-0 font-medium py-2 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 flex items-center space-x-2 ${
            paidInvoicesCount > 0
        ...
        >
          ...
          <span>Download All ({paidInvoicesCount})</span>
        </button>
      </div>
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 dark:placeholder-gray-500"
              />
            </div>
          </div>
          <div className="relative">
            ...
            <select
              ...
              className="pl-10 pr-8 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none"
            >
